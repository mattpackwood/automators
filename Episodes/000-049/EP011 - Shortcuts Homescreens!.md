...
| 02:06      | So the 20,000 foot view, what we're talking about is when you're in [[Shortcuts\|Siri Shortcuts]], you              |
...
| 03:02      | but instead these launchers and other utilities you've created out of the [[Shortcuts\|Siri Shortcuts]] app.        |
...
| 04:35      | It's like we're all Doug.                                                                             |
| 04:37      | We're all Doug.                                                                                       |
| 04:38      | Exactly.                                                                                             |
...
| 05:10      | So say, just take me to the MacSparky inbox, and you can do that, or you can have a shortcut       |
| 05:16      | that just opens a compose window in [[Drafts]], and then you can avoid the [[Apple Mail\|Mail]] app altogether.          |
...
| 06:53      | and the internet, if they type in, I don't know, [bbc.co.uk](https://bbc.co.uk), then they get the BBC News               |
| 06:59      | website.                                                                                             |
...
| 07:44      | I could set up a button on her home screen that just does it all for her with [[Shortcuts\|Siri Shortcuts]].        |
...
| 10:37      | So you could say one is [[Fantastical]] and one is OmniFocus and one is [[AirMail]].                        |
...
| 11:10      | of the [[AirMail]] one you copy in the open app command in Siri.                                        |
...
| 11:26      | We'll talk about that later, but [[AirMail]] is there.                                                  |
| 11:28      | So you tap [[AirMail]].                                                                                 |
| 11:29      | Now, when you run that shortcut and you tap on the [[AirMail]] button, it's going to go and             |
| 11:35      | open the [[AirMail]] application.                                                                       |
...
| 13:15      | And I guess I'm kind of getting ahead a little bit, but that's an example of a choose from           |
...
| 16:15      | view.                                                                                                |
| 16:16      | To find out more about how to use OmniFocus, check out [insideomnifocus.com](https://insideomnifocus.com), where various            |
| 16:22      | people, including David and myself, have written articles about how we use OmniFocus every           |
| 16:26      | day.                                                                                                 |
| 16:28      | Go to [omnifocus.com](https://omnifocus.com) right now and start getting more done.                                           |
| 16:31      | That's [omnifocus.com](https://omnifocus.com).                                                                                |
| 16:33      | OmniFocus accomplish more every day.                                                                 |
| 16:35      | Our thanks to the Omni Group for their support of this show and Relay FM.                            |
| 16:39      | I thought maybe to begin with, I would share one that is a very simple [[Shortcuts\|Siri Shortcut]] app             |
| 16:47      | home screen launcher.                                                                              |
...
| 17:09      | There's [[Apple Mail\|Mail]], [[Apple Messages\|Messages]], [[Slack]], [[Discourse]], [[Twitter]], and an [[AirMail]], because I've been                |
| 17:16      | playing with [[AirMail]] thanks to Rose.                                                                |
...
| 18:03      | But it presents a list of different [[HomeKit]] scenes for me to run.                                   |
...
| 18:37      | And that just allows me to access the [[HomeKit]] scenes that I actually really want to                 |
...
| 20:53      | And for instance, the projects one is at `OmniFocus:///projects`.                 |
...
| 21:37      | So if I press the templates button in this OmniSelect, it brings me to another Siri                |
| 21:42      | shortcut that says, are you making a MacSparky template, a legal template or a personal template?       |
...
| 25:10      | for the [[Shortcuts\|Siri Shortcuts]] app.                                                                          |
| 25:12      | So hopefully they'll have that fixed in the next version.                                            |
| 25:14      | Yes.                                                                                                 |
| 25:15      | The exact error message it says, this action requires "do not disturb intents" to be installed.         |
...
| 25:41      | So I have an automated shortcut, a [Sweet Setup](https://thesweetsetup.com) shortcut when I'm doing quick tips to the             |
| 25:46      | [Sweet Setup](https://thesweetsetup.com), my [MacStories](https://www.macstories.net) shortcut and [Learn OmniFocus](https://learnomnifocus.com), which they list a variety of             |
| 25:52      | things.                                                                                              |
...
| 29:05      | brings me to the [[Google Docs\|Google Doc]] or the [[Quip\|Quip Doc]] or the [[Apple Notes\|Apple Note]], because I do, we work in              |
...
| 29:31      | a whole bunch of time in an [[OmniOutliner]] outlined for it.                                           |
...
| 29:50      | I've got [[MindNode]] stuff, just all the things I regularly do as MacSparky are here, and                |
| 29:58      | it allows me to get to them very easily.                                                             |
| 30:00      | Everyone I've got in here is the admin panel for the [learn.macsparky site](learn.macsparky.com), if a customer             |
...
| 31:29      | kit, like common [[HomeKit]] tasks.                                                                     |
| 31:33      | I think that's a great use for this because [[HomeKit]] is actually a little tedious to get             |
| 31:37      | to.                                                                                                  |
| 31:38      | Definitely.                                                                                          |
...
| 31:51      | limited access to [[HomeKit]] through [[Shortcuts\|Siri Shortcuts]].                                                   |
...
| 32:07      | They have, since we started, actually added the option to choose a [[HomeKit]] scene instead            |
...
| 34:08      | or you could, and I have done this for a few people, especially some group chats in [[Apple Messages\|iMessage]],        |
...
| 34:40      | One of the things I think they made a mistake with with [[Shortcuts\|Siri Shortcuts]] is when they give             |
...
| 35:44      | as well as I have one saying 'send "I know!"' to my mom, it has the option to just send  |
...
| 37:22      | It gets me on the [[HBO\|HBO app]] opens the [[Apple TV App\|TV app]].                                                          |
...
| 40:10      | I was looking, I have a travel one where it's got things like *Open Google Maps* and *Open Maps*,             |
| 40:15      | but it's also got ones that get specific directions or get me where I'm at or it's             |
...
| 42:27      | And if you try and open [[Twitter]] past 10 pm, it's like, nope, go to bed.                            |
...
| 45:17      | And on that episode, [[Myke Hurley\|Myke]] made the recommendation, which I think is brilliant, is to have secret     |
...
| 46:26      | when you run it from your home screen, it's going to jump into the [[Shortcuts\|Siri Shortcuts]] app.               |
...
| 47:14      | I wish that, or maybe, hopefully, with a future version of [[Shortcuts\|Siri Shortcuts]], it won't drag you         |
| 47:20      | through that process.                                                                                |
| 47:22      | Interestingly, an alternative, and what I've been using is you can put these things on               |
| 47:28      | your widget screen, too, how the widget screen has a [[Shortcuts\|Siri Shortcuts]] widget.                          |
| 47:33      | If you put that on there and you're judicious in the way you set up your widget screen,              |
| 47:39      | you can select in the [[Shortcuts\|Siri Shortcuts]] app, which applications get on your widget screen,              |
...
| 47:50      | And in that case, it doesn't go to [[Safari]], it doesn't go to the [[Shortcuts\|Siri Shortcuts]] app.                  |
...
| 49:53      | What's in your dock these days, Rose?                                                                |
...
| 50:59      | mention earlier, but some applications like, for example, [[Quip]], I use for more than one            |
| 51:04      | purpose and they, unfortunately, are not shortcut-accessible, which means that all I can do is open  |
| 51:09      | the app.                                                                                             |
...
| 51:32      | Some apps just are not available, like the [[Apple Camera\|Camera]] app, for instance, which is super frustrating.     |
| 51:37      | I've got a whole camera shortcut system, but the actual [[Apple Camera\|Camera]] app isn't in it because               |
...
| 52:01      | It is odd that some of the [[Apple]] apps are the ones that are not [[Shortcuts\|Siri shortcut]]-friendly.              |
| 52:05      | Yeah.                                                                                                |
...
| 52:25      | So you can't do everything with [[Shortcuts\|Siri Shortcuts]], but you can do a lot, and this is something          |
...
| 52:54      | of everything.                                                                                       |
| 52:55      | Like I said, I've got OmniSelect in my dock, I've got the, especially the legal and the             |
...
| 53:11      | That whole thing jumping to [[Safari]] and then back to [[Shortcuts\|Siri Shortcuts]] really just makes me              |
...
| 56:01      | it.                                                                                                  |
| 56:02      | Yeah, my thanks to Grey for kind of leading, blazing the trail here.                                 |
| 56:06      | Yes.                                                                                                 |
| 56:07      | And we did ask him, unfortunately, he wasn't able to be on today's show, but and he did              |
| 56:12      | send me a comment that he wanted to include, which is shortcut launchers to launch shortcuts          |
| 56:16      | are just the best.                                                                                     |
...
| 56:26      | So give it a try and share them with us over at [talk.automators.fm](https://talk.automators.fm).   |
| 56:33      | Yes.                                                                                                 |
...
| 57:06      | It's a great way to exercise your [[Shortcuts]] skills, especially if you're getting to grips             |
...
| 57:24      | You can find us at [automators.fm](https://automators.fm).                                                                    |
| 57:27      | We've got a great forum over at [talk.automators.fm](https://talk.automators.fm).                                                  |
...
| 57:58      | Err Rose is on [[Twitter]] @rosemaryorchard.                                                          |
| 58:00      | I am on [[Twitter]] @MacSparky.                                                                        |
| 58:03      | Thank you OmniGroup for sponsoring this episode.                                                    |
